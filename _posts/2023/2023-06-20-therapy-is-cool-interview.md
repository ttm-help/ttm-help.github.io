---
layout: post
title: "Где я, там хорошо! Видео-интервью с пациентом Юлией"
description: "Это интервью с моим пациентом, которая страдала трихотилломанией 20 лет и процесс её выздоровления занял всего 3 месяца. О результатах этой психотерапии она рассказывает в этом видео"
...
video:
    ...
    duration: PT32M15S
image:
  url: /assets/img/2024/interview-thumbnail-3.webp
---
